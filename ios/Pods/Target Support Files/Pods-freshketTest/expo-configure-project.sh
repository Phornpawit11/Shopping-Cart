...
with_node \
  ...
  --target "/Users/overwhelmed/Desktop/WORKS/freshketTest/ios/Pods/Target Support Files/Pods-freshketTest/ExpoModulesProvider.swift" \
  --entitlement "/Users/overwhelmed/Desktop/WORKS/freshketTest/ios/freshketTest/freshketTest.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-asset" "expo-constants" "expo-dev-launcher" "expo-dev-menu" "expo-file-system" "expo-font" "expo-keep-awake" "expo-splash-screen" "expo-system-ui"
